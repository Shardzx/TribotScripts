...
public class EzHellratCatcher extends Script implements MessageListening07, Arguments, Painting {
    ...
    public void onPaint(Graphics g) {
        ...
        if (Vars.battleMode) {
            g.drawString("Behemoths battled: " + Vars.behemothsFought, 5, 110);
            g.drawString("Cat current health: " + Vars.currentCatHealth + ", eat at: " + Vars.nextHealPercentage, 5, 130);
        } else {
    ...
    public void run() {
        ...
        Utilities.acamera = Vars.acamera;
